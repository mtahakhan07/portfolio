...
const Hero = () => {
    const handleDownloadResume = () => {
        ...
        link.href = '/RESUME_TAHA.pdf';
        link.download = 'Muhammad_Taha_Khan_Resume.pdf';
            ...
            <div className='-top-40 -left-10 md:-left-32 md:-top-20 h-full'>
                ...
                <div className="flex justify-center relative py-8 md:py-12 lg:py-16 z-10">
                    <div className="w-full max-w-7xl px-4 sm:px-6 md:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 items-center justify-items-center lg:justify-items-start gap-8 md:gap-10 lg:gap-16">
                            ...
                            <div className="flex flex-col items-center lg:items-start text-center lg:text-left order-1 lg:order-2">
                                ...
                                <div className="mt-4 self-center lg:self-start hidden lg:block">
                                    <MagicButton
                        ...
                        {/* Mobile download button - below image */}
